        ...
        <div className="justify-center">
            <center className="mt-24 m-auto">
                ...
                <div className=" tracking-widest mt-4">
                    <span className="text-gray-500 text-6xl block"><span>! Payment Failed</span></span>
                    <span className="text-gray-500 text-xl">Sorry, We couldn't process your payment!</span>
                </div>
            </center>
