...
function CategoryProductDetails() {
  ...
  return (
    <section className="flex flex-col lg:flex-row">
      <div className="images-container flex-shrink-0 w-full lg:w-1/3 relative md:border border-secondary p-4 h-fit">
        ...
        <div className="actions-container flex item-center gap-5">
          ...
          <Button className="w-1/2 uppercase">
            <Zap />
            Buy Now
          </Button>
        </div>
